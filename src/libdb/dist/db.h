...
#define	DB_VERSION_STRING	"Sleepycat Software: Berkeley DB 4.1.25: (October 11, 2004)"
 ...
 */
#define	dbm_clearerr(a)		__db_ndbm_clearerr_eds(a)
#define	dbm_close(a)		__db_ndbm_close_eds(a)
#define	dbm_delete(a, b)	__db_ndbm_delete_eds(a, b)
#define	dbm_dirfno(a)		__db_ndbm_dirfno_eds(a)
#define	dbm_error(a)		__db_ndbm_error_eds(a)
#define	dbm_fetch(a, b)		__db_ndbm_fetch_eds(a, b)
#define	dbm_firstkey(a)		__db_ndbm_firstkey_eds(a)
#define	dbm_nextkey(a)		__db_ndbm_nextkey_eds(a)
#define	dbm_open(a, b, c)	__db_ndbm_open_eds(a, b, c)
#define	dbm_pagfno(a)		__db_ndbm_pagfno_eds(a)
#define	dbm_rdonly(a)		__db_ndbm_rdonly_eds(a)
#define	dbm_store(a, b, c, d) \
	__db_ndbm_store_eds(a, b, c, d)
 ...
 */
#define	dbminit(a)	__db_dbm_init_eds(a)
#define	dbmclose	__db_dbm_close_eds
#if !defined(__cplusplus)
#define	delete(a)	__db_dbm_delete_eds(a)
#endif
#define	fetch(a)	__db_dbm_fetch_eds(a)
#define	firstkey	__db_dbm_firstkey_eds
#define	nextkey(a)	__db_dbm_nextkey_eds(a)
#define	store(a, b)	__db_dbm_store_eds(a, b)
...
#define	hcreate(a)	__db_hcreate_eds(a)
#define	hdestroy	__db_hdestroy_eds
#define	hsearch(a, b)	__db_hsearch_eds(a, b)
...
#define	db_create db_create_eds
#define	db_strerror db_strerror_eds
#define	db_env_create db_env_create_eds
#define	db_version db_version_eds
#define	log_compare log_compare_eds
#define	db_env_set_func_close db_env_set_func_close_eds
#define	db_env_set_func_dirfree db_env_set_func_dirfree_eds
#define	db_env_set_func_dirlist db_env_set_func_dirlist_eds
#define	db_env_set_func_exists db_env_set_func_exists_eds
#define	db_env_set_func_free db_env_set_func_free_eds
#define	db_env_set_func_fsync db_env_set_func_fsync_eds
#define	db_env_set_func_ioinfo db_env_set_func_ioinfo_eds
#define	db_env_set_func_malloc db_env_set_func_malloc_eds
#define	db_env_set_func_map db_env_set_func_map_eds
#define	db_env_set_func_open db_env_set_func_open_eds
#define	db_env_set_func_read db_env_set_func_read_eds
#define	db_env_set_func_realloc db_env_set_func_realloc_eds
#define	db_env_set_func_rename db_env_set_func_rename_eds
#define	db_env_set_func_seek db_env_set_func_seek_eds
#define	db_env_set_func_sleep db_env_set_func_sleep_eds
#define	db_env_set_func_unlink db_env_set_func_unlink_eds
#define	db_env_set_func_unmap db_env_set_func_unmap_eds
#define	db_env_set_func_write db_env_set_func_write_eds
#define	db_env_set_func_yield db_env_set_func_yield_eds
#if DB_DBM_HSEARCH != 0
#define	__db_ndbm_clearerr __db_ndbm_clearerr_eds
#define	__db_ndbm_close __db_ndbm_close_eds
#define	__db_ndbm_delete __db_ndbm_delete_eds
#define	__db_ndbm_dirfno __db_ndbm_dirfno_eds
#define	__db_ndbm_error __db_ndbm_error_eds
#define	__db_ndbm_fetch __db_ndbm_fetch_eds
#define	__db_ndbm_firstkey __db_ndbm_firstkey_eds
#define	__db_ndbm_nextkey __db_ndbm_nextkey_eds
#define	__db_ndbm_open __db_ndbm_open_eds
#define	__db_ndbm_pagfno __db_ndbm_pagfno_eds
#define	__db_ndbm_rdonly __db_ndbm_rdonly_eds
#define	__db_ndbm_store __db_ndbm_store_eds
#define	__db_dbm_close __db_dbm_close_eds
#define	__db_dbm_dbrdonly __db_dbm_dbrdonly_eds
#define	__db_dbm_delete __db_dbm_delete_eds
#define	__db_dbm_dirf __db_dbm_dirf_eds
#define	__db_dbm_fetch __db_dbm_fetch_eds
#define	__db_dbm_firstkey __db_dbm_firstkey_eds
#define	__db_dbm_init __db_dbm_init_eds
#define	__db_dbm_nextkey __db_dbm_nextkey_eds
#define	__db_dbm_pagf __db_dbm_pagf_eds
#define	__db_dbm_store __db_dbm_store_eds
#endif
#if DB_DBM_HSEARCH != 0
#define	__db_hcreate __db_hcreate_eds
#define	__db_hsearch __db_hsearch_eds
#define	__db_hdestroy __db_hdestroy_eds
#endif
#define db_xa_switch db_xa_switch_eds
