...
void
e_data_server_ui_marshal_BOOLEAN__OBJECT_BOXED (GClosure     *closure,
...
void
e_data_server_ui_marshal_BOOLEAN__BOXED_OBJECT_FLAGS_UINT (GClosure     *closure,
                                                           GValue       *return_value G_GNUC_UNUSED,
                                                           guint         n_param_values,
                                                           const GValue *param_values,
                                                           gpointer      invocation_hint G_GNUC_UNUSED,
                                                           gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__BOXED_OBJECT_FLAGS_UINT) (gpointer     data1,
                                                                     gpointer     arg_1,
                                                                     gpointer     arg_2,
                                                                     guint        arg_3,
                                                                     guint        arg_4,
                                                                     gpointer     data2);
  register GMarshalFunc_BOOLEAN__BOXED_OBJECT_FLAGS_UINT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
  ...
  callback = (GMarshalFunc_BOOLEAN__BOXED_OBJECT_FLAGS_UINT) (marshal_data ? marshal_data : cc->callback);
